...
<q-page class="flex flex-center">
 <q-card class="q-ma-md" style="max-width: 400px" >
  ...
  <q-form  class="q-ma-md">
    ...
    <q-input v-model="userDetail.description" label="个人简介" lazy-rules :rules="[(val) => !!val || '请输入个人简介']">
      <template #before>
...
<q-card-actions align="right">
      ...
      <q-btn flat label="保存" color="primary" type="submit" :disable="checkSame(userDetail,userDetailCopy)" @click="submit"/>
    </q-card-actions>
  </q-form>
 </q-card>
</q-page>
